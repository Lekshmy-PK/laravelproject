            ...
            <div class="bg-appointment rounded">
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-lg-6 py-5">
                        <h1 class="text-center text-white mb-4">Case Approval</h1>
                        <form>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control border-0 p-4" placeholder="Casetype" required="required" />
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control border-0 p-4" placeholder="Casedescription" required="required" />
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control border-0 p-4" placeholder="Name of case respondent" required="required" />
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control border-0 p-4" placeholder="Address of case respondent" required="required" />
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control border-0 p-4" placeholder="Phonenumber of case respondent" required="required" />
                            </div>
                            <div class="form-group">
                                <label style="color: azure;">FilingDate </label>
                                <input type="date" class="form-control border-0 p-4" placeholder="date" required="required" />
                            </div>
                            <div class="form-group">
                                <label style="color: azure;">ClosingDate </label>
                                <input type="date" class="form-control border-0 p-4" placeholder="date" required="required" />
                            </div>
                            ...
                            <div>
                                <button class="btn btn-primary btn-block border-0 py-3" type="submit">APPROVE</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Lawyers</a>
